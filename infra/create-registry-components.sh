...
az ml component create --file "./cli/jobs/pipelines-with-components/basics/4b_datastore_datapath_uri/component-file.yml" --registry-name $REGISTRY_NAME -n component-file_4b_datastore_datapath_uri -v 1 > /dev/null 2>&1
az ml component create --file "./cli/jobs/pipelines-with-components/basics/4b_datastore_datapath_uri/component-folder.yml" --registry-name $REGISTRY_NAME -n component-folder_4b_datastore_datapath_uri -v 1 > /dev/null 2>&1
...
az ml component create --file "./cli/jobs/pipelines-with-components/basics/4d_data_input/component-hello.yml" --registry-name $REGISTRY_NAME -n component-hello_4d_data_input -v 1 > /dev/null 2>&1
az ml component create --file "./cli/jobs/pipelines-with-components/basics/4d_data_input/component-world.yml" --registry-name $REGISTRY_NAME -n component-world_4d_data_input -v 1 > /dev/null 2>&1
